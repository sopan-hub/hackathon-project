  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-20 hidden h-svh transition-[left,right,width] ease-linear md:flex eco-sidebar",
            side === "left"
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-background transition-[padding] ease-linear",
